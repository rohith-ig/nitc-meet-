      ...
      <div
        ...
        <div className=" w-[97%] h-full flex flex-row justify-between">
          ...
          <div className=" w-[30%] h-[60%] m-[12.5%] flex flex-col items-center">
            ...
            <a href="#" className="bg-[#0000007b] w-[192px] h-[56px] rounded-[15px] m-4 backdrop-blur-md shadow-lg shadow-black text-center items-center flex justify-center hover:bg-white hover:text-[#111317] transition-colors duration-300 ease-in-out">
              Login with Google
            </a>
